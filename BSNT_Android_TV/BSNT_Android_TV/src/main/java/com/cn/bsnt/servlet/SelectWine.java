...
import com.cn.bsnt.service.impl.GoodsWineServiceImpl;
...
@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
	   ...
	   resp.setCharacterEncoding("utf-8");
		...
		String result =null;
		try {
			GoodsWineService gws = new GoodsWineServiceImpl();
			List<GoodsWine> GoodsWineList = new ArrayList<GoodsWine>();
			if(GoodsWineList!=null){
				i=1;
				result = "{\"state\":\"i\",\"wineList\":" + GoodsWineList + "}";
			}else{
				result = "{\"state\":\"0\",\"wineList\":" + GoodsWineList + "}";
			}
